...
.stat-card { background: #fff; border: 1px solid #e2e8f0; border-radius: 12px; padding: 1.1rem; display: flex; align-items: center; gap: .9rem; }
...
.si-green { background: #d1fae5; } .si-red { background: #fee2e2; } .si-amber { background: #fef3c7; } .si-blue { background: #dbeafe; }
.stat-val { font-size: 1.65rem; font-weight: 800; line-height: 1; }
.stat-label { font-size: .8rem; color: #64748b; margin-top: .2rem; }
.alert-low { background: #fef2f2; border: 1px solid #fca5a5; border-radius: 10px; padding: .85rem 1.2rem; font-size: .92rem; margin-bottom: 1.5rem; color: #991b1b; }
.toolbar { display: flex; gap: .75rem; margin-bottom: 1.5rem; flex-wrap: wrap; align-items: center; }
.input-search { flex: 1; min-width: 200px; padding: .6rem 1rem; border: 1.5px solid #e2e8f0; border-radius: 8px; font-size: .95rem; outline: none; transition: border-color .2s; }
.input-search:focus { border-color: #10b981; }
.input-select { padding: .6rem .9rem; border: 1.5px solid #e2e8f0; border-radius: 8px; background: #fff; font-size: .9rem; outline: none; cursor: pointer; }
...
.product-grid { display: grid; grid-template-columns: repeat(auto-fill, minmax(275px, 1fr)); gap: 1.2rem; }
.product-card { background: #fff; border: 1px solid #e2e8f0; border-radius: 14px; overflow: hidden; transition: transform .2s, box-shadow .2s; }
...
.cat-badge { display: inline-block; padding: .2rem .65rem; border-radius: 20px; font-size: .72rem; font-weight: 700; margin-bottom: .6rem; }
.c-elec { background: #dbeafe; color: #1e40af; } .c-cloth { background: #fce7f3; color: #9d174d; }
.c-foot { background: #f3e8ff; color: #6b21a8; } .c-food { background: #fef3c7; color: #92400e; }
.c-sport { background: #d1fae5; color: #065f46; } .c-book { background: #e0f2fe; color: #0369a1; }
.c-furn { background: #fdf4ff; color: #7e22ce; } .c-bag { background: #fff7ed; color: #9a3412; }
.c-acc { background: #f0fdf4; color: #15803d; } .c-tool { background: #f1f5f9; color: #475569; }
...
.stock-num.out { color: #9ca3af; } .stock-num.low { color: #dc2626; }
.stock-num.mid { color: #d97706; } .stock-num.high { color: #059669; }
...
.stock-fill.out { background: #d1d5db; width: 2% !important; } .stock-fill.low { background: #dc2626; }
.stock-fill.mid { background: #f59e0b; } .stock-fill.high { background: #10b981; }
.card-footer { display: flex; gap: .5rem; padding: .75rem 1.1rem; border-top: 1px solid #f1f5f9; background: #fafafa; }
.btn-edit, .btn-del { flex: 1; padding: .45rem; border-radius: 7px; font-size: .82rem; font-weight: 600; cursor: pointer; border: none; transition: all .2s; }
...
.overlay { position: fixed; inset: 0; background: rgba(0,0,0,.45); display: flex; align-items: center; justify-content: center; z-index: 500; padding: 1rem; }
.modal { background: #fff; border-radius: 16px; width: 100%; max-width: 480px; max-height: 90vh; overflow-y: auto; padding: 2rem; }
...
.form-input { width: 100%; padding: .6rem .85rem; border: 1.5px solid #e2e8f0; border-radius: 8px; font-size: .95rem; outline: none; transition: border-color .2s; }
.form-input:focus { border-color: #10b981; }
.form-row { display: grid; grid-template-columns: 1fr 1fr; gap: .75rem; }
.modal-footer { display: flex; gap: .75rem; justify-content: flex-end; padding-top: 1rem; border-top: 1px solid #f1f5f9; margin-top: 1rem; }
.btn-cancel { background: #f1f5f9; color: #334155; border: none; border-radius: 8px; padding: .6rem 1.25rem; font-weight: 600; cursor: pointer; }
.btn-cancel:hover { background: #e2e8f0; }
.btn-save { background: #10b981; color: #fff; border: none; border-radius: 8px; padding: .6rem 1.25rem; font-weight: 700; cursor: pointer; }
...
.btn-danger-confirm { background: #dc2626; color: #fff; border: none; border-radius: 8px; padding: .6rem 1.4rem; font-weight: 700; cursor: pointer; }
.btn-danger-confirm:hover { background: #b91c1c; }
@media (max-width: 640px) { .form-row { grid-template-columns: 1fr; } .stats-grid { grid-template-columns: 1fr 1fr; } }
</style>
